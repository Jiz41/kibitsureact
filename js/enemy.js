...
/* ── Oni ────────────────────────────────────── */
const ONI_HP   = 10, /* 元: 160 */ ONI_SPD  = 55, ONI_DMG  = 15;
const ONI_ATK  = 2000, ONI_RNG = 75, ONI_INT  = 2000;
const ONI_WAVE = 10,   ONI_W   = 38, ONI_H    = 54;
const ONI_BW   = 38,   ONI_BH  = 5;

/* ── Named ──────────────────────────────────── */
const NM_HP = 10, /* 元: 480 */ NM_SPD = 35, NM_DMG = 25;

/* ── Ogre (WAVE8-9 中ボス) ───────────────────── */
const OGRE_HP = 400, OGRE_SPD = 30, OGRE_DMG = 28;

/* ── Boss ───────────────────────────────────── */
const BOSS_HP = 10, /* 元: 800 */ BOSS_SPD = 20, BOSS_DMG = 35;
